...
def mostrar_datos(dniLista, apellidoLista, nombreLista, edadLista, 
    ...
    boton_informe = tk.Button(ventana_datos, text="Estadísticas", command=generar_estadistica)
    boton_informe.pack(pady=20)

    boton_buscar = tk.Button(ventana_datos, text="Buscar registro", command=buscar_registro)
...
def buscar_registro():
    ...
    etiqueta = tk.Label(ventana, text="Para buscar un registro ingrese el DNI del contribuyente:")
